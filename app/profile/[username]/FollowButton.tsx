  ...
  if (isFollowing) {
    ...
    return (
      <button
        ...
        className="inline-flex h-8 items-center justify-center rounded-full bg-[color:var(--brand-primary)] px-4 text-xs font-semibold text-[color:var(--text-inverse)] shadow-sm transition hover:bg-[color:var(--brand-primary-hover)] focus:outline-none focus:ring-2 focus:ring-[color:var(--border-focus)] focus:ring-offset-2"
      >
        Following ✓
      </button>
    );
