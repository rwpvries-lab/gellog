...
export function Cup({ tokens, size, seed, className }: CupProps) {
  ...
  return (
    ...
    >
      ...
      >
        <ellipse cx="452.5" cy="967.283" rx="373.785" ry="132.718" fill="#0D9488" />
        ...
        <path d="M53.0264 419.019C53.1212 424.546 53.485 429.944 54.1133 435.213C34.0478 449.957 23 466.068 23 482.946C23 553.363 215.294 610.446 452.5 610.446C689.706 610.446 882 553.363 882 482.946C882 466.34 871.305 450.476 851.849 435.927C852.609 431.482 853 426.982 853 422.432C853 421.512 852.982 420.593 852.95 419.676C886.185 442.152 905 467.765 905 494.946C905 584.14 702.409 656.446 452.5 656.446C202.591 656.446 0 584.14 0 494.946C0 467.5 19.1836 441.652 53.0264 419.019Z" fill="#EFEFE5" />
      </svg>
    </div>
  );
}
